...
--
--  This generates a file gen/charades-features.t7 which contains the list of all
...
local function load_feature_from_txt(filename)
    file = io.open(filename)
    feature = torch.Tensor(file:lines()():split(' '))
    file:close()
    return feature
end
